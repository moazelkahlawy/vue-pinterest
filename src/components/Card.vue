<template>
    <div @mouseover="hover = true" @mouseleave="hover = false" class="relative">
        ...
        <div v-if="hover" class="absolute bg-dark opacity-50 inset-0 w-full h-full rounded-lg">
            <div v-if="hover" class="absolute top-0 w-full h-full flex flex-col justify-between p-3">
                ...
                <div class="flex items-center w-full">
                    <button type="button" name="button" class="ml-auto mr-2 bg-white rounded-full w-8 h-8 flex items-center justify-center p-2 text-dark opacity-75 hover:opacity-100">
                        <span class="material-icons text-base">ios_share</span>
                    </button>
                    <button type="button" name="button" class="bg-white rounded-full w-8 h-8 flex items-center justify-center p-2 text-dark opacity-75 hover:opacity-100">
